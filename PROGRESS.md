...
- 最终重新下载审计再次通过：公开 Release 7 个资产的 `shasum -a 256 -c SHA256SUMS.txt` 全部 `OK`；`BUILD-INFO.json` 为 `tag=v1.0.1`、`version=1.0.1`、`schema_version=1.0.0`、`unsigned=true`，commit/build_commit 均为 `e7bd4fa5eae6295cdd81fd7829b47f48304ac3bf`。
