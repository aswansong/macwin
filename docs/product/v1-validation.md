...
候选版本目标为前端/Tauri `1.0.1-rc.2`、Cargo `1.0.1`；`.habitpack` schema、ruleset 与 snapshot 继续保持 `1.0.0`。集成提交 `51eaea95c61568c408a16d8c3954c87c99a94790` 的 v1 validation run `31062124936`、unsigned RC run `31062124948` 及 publish job `92493455217` 均成功；Pre-release、同一提交和双平台 SHA-256 已下载复核。[D-042、E-055]
...
| GitHub 未签名 RC | Actions `31062124948` 与 publish job `92493455217` 成功；Pre-release 含 Windows x64 NSIS、Apple Silicon DMG、`README-TESTING.md` 和总 `SHA256SUMS.txt`，下载后两项均 `sha256sum -c ...: OK` | 只供负责人和知情测试者；不合并 `main`，不替代正式签名、公证或真实设备验收 |
