...
截至 2026-08-02，M1 第二版可点击原型和 `.habitpack` `1.0.0` 严格验证档案已经完成；Alpha 0.1/0.2 的真实 Mac 证据已归档，当前在 `release/v1.0.0` 推进正式实现。部分 P0 已标为 `implemented`，但仍需真实设备发布验证；Wi‑Fi 凭据、可信软件自动安装、签名更新、公证和 Release 继续受各自决策门约束。[D-032、E-021]
