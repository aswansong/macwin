...
截至 2026-08-02，M1 第二版可点击原型和 `.habitpack` `1.0.0` 严格验证档案已经完成；Alpha 0.1 纵向切片在独立分支开发并受 D-030 限制。部分 P0 已标为 `implemented`，但尚未完成真实设备发布验证；Wi‑Fi/密码、Ctrl 兼容层、第三方安装、UAC/TCC、真实秘密、更新和 Release 仍未授权。[D-028、D-030、E-019]
