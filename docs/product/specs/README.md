...
截至 2026-07-31，M1 第二版可点击原型和 `.habitpack` `1.0.0` 严格验证档案已经完成，项目正在等待下一阶段授权。本仓库没有生产应用代码、真实规则或安装器；所有 P0（包括 P0-004）仍为 `specified`，原型与虚构夹具结果不构成产品实现或真实设备测试。[D-024、D-028]
