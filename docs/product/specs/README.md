...
截至 2026-08-06，M1 第二版可点击原型、`.habitpack` `1.0.0` 严格验证档案和 v1.0.0 RC 已归档；当前在 `integration/v1.0.1-final-convergence` 收口 `1.0.1-rc.2` 未签名测试包。部分 P0 已标为 `implemented`，但仍需真实设备发布验证；Wi‑Fi 凭据、可信软件自动安装、签名更新、公证和正式 Release 继续受各自决策门约束。[D-041、D-042、E-051]
